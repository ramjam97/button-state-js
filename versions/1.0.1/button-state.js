/*
github: https://github.com/ramjam97/button-state-js/blob/master/versions/1.0.1/button-state.min.js
version: 1.0.0
author: Ram Jam
*/
...
function useBtnState(btnSelector = null, options = {}) {
    ...
    // --- actions ---
    const loading = (flag) => setState({ isLoading: flag, isDisabled: flag });
    const disabled = (flag) => setState({ isDisabled: flag });
